...
document.addEventListener('DOMContentLoaded', function() {
  var fonts = [
    ...
    { label: 'Fraunces',        sub: 'Old Style soft-serif',  value: "'Fraunces', Georgia, serif",              cardName: 'Fraunces',         cardRole: 'Wonky and warm with a playful Old Style soul. A display variable font with four axes — weight, softness, wonk, and optical size.',  cardDesigner: 'Undercase Type',      cardClass: 'Old Style serif',      cardWeights: '100–900',   cardUsed: 'Display, headlines' },
